...
abstract class Jelly_Builder_Core extends Kohana_Database_Query_Builder_Select {
    ...
    public  function distance($id=null) {
        if(isset ($id)) {
            return $this->join('hoteldistance', 'left')->on('hoteldistance.id_object','=',':primary_key')
                    ->where('hoteldistance.hoteldistanceobject_id','=',$id)
                    ->order_by('hoteldistance.distance');
        }else{
            return $this;
        }
    }
    public  function price($id=null) {
        if(isset ($id)) {
            return $this->join('hotelprices_hotels')->on('hotelprices_hotels.hotel_id','=','hotel:primary_key')
                                    ->where('hotelprices_hotels.hotelprice_id','=',$id);
        }else{
            return $this;
        }
    }
    public  function hotel_kind($id=null) {
        if(isset ($id)) {
            return $this->where('hotel.hotelkind_id','=',$id);
        }else{
            return $this;
        }
    }
    public  function hotel_name($name) {
        if(isset ($name)) {
            return $this->where('hotel.name','LIKE',"%$name%");
        }else{
            return $this;
        }
    }
